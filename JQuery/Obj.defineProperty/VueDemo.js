/**
 * 此案例用于说明Vue中响应模式，利用Object.defineProperty和订阅者模式
 */
...
console.log('data.name 改变之前');
data.name = 'zht';
console.log('data.name 改变之后');
...
console.log('data.obj.name 改变之前');
data.obj.name = 'cwc';
data.obj.name = 'dmh';
console.log('data.obj.name 改变之后');
